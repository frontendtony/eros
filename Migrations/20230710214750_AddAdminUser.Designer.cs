...
namespace EstateManager.Migrations
{
    ...
    [Migration("20230710214750_AddAdminUser")]
            ...
            modelBuilder.Entity("EstateManager.Entities.EstatePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dc34dd3d-24fd-4489-80cb-c61603e84747"),
                            Description = "Permission to create an estate",
                            Name = "CreateEstate"
                        },
                        new
                        {
                            Id = new Guid("6088b2d8-3400-4677-96bc-04c90dc57b40"),
                            Description = "Permission to update an estate",
                            Name = "UpdateEstate"
                        },
                        new
                        {
                            Id = new Guid("d898d4c4-1b6a-4225-8013-e9b8a8ffec20"),
                            Description = "Permission to delete an estate",
                            Name = "DeleteEstate"
                        },
                        new
                        {
                            Id = new Guid("31c35a30-3f72-4edb-9c0d-cceb9f9aa2b8"),
                            Description = "Permission to create an estate building",
                            Name = "CreateEstateBuilding"
                        },
                        new
                        {
                            Id = new Guid("169b0302-cb70-4a8c-a046-398d4daf74a4"),
                            Description = "Permission to update an estate building",
                            Name = "UpdateEstateBuilding"
                        },
                        new
                        {
                            Id = new Guid("e8e3c5a0-8e21-4c2a-94ad-344ed8e8ed6d"),
